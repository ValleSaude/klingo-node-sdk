...
var Api = /*#__PURE__*/function () {
  function Api() {
    ...
    axios.interceptors.request.use(function (request) {
      if (!request.url.includes('register') && !request.url.includes('login') && !request.url.includes('live') && !request.url.includes('profissionais') && !validate.authenticated(request.headers)) {
