          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios.get("".concat(this.options.base["default"], "/").concat(config.schedule.available), {
                  headers: headers,
                  params: queryString
                });
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return axios["delete"]("".concat(this.options.base["default"], "/").concat(config.schedule.voucher), {
                  headers: headers,
                  body: body
                });
