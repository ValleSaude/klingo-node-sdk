 ...
 * isEmail
 */function isEmail(a){return /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test((a+"").toLowerCase())}/**
 * client
 * @param {Object} params
 * @return {Boolean}
 */function client(a){if(isObject(a)){var b=["xAppToken","env","log"];for(var c in a=Object.keys(a),b)if(-1===a.indexOf(b[c]))return;return!0}}/**
 * authenticated
 * @param {Object} opts
 * @return {Boolean}
 */function authenticated(a){if(isObject(a)){var b=["authentication"];for(var c in a=Object.keys(a),b)if(-1===a.indexOf(b[c]))return;return!0}}/**
 * exports
 */module.exports={isString:isString,isNumber:isNumber,isArray:isArray,isFunction:isFunction,isObject:isObject,isNull:isNull,isUndefined:isUndefined,isBoolean:isBoolean,isRegExp:isRegExp,isError:isError,isSymbol:isSymbol,isDate:isDate,isEmail:isEmail,isEquivalent:isEquivalent,client:client,authenticated:authenticated};