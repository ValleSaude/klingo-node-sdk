...
const confirm = async (opts, params) => {
  ...
  */
  ...
  try {
    ...
    const response = await request({
      ...opts,
      url: `${opts.base.default}/${config.schedule.confirm}`,
...
const listVouchers = async opts => {
  ...
  */
  ...
  try {
    ...
    const response = await request({
      ...opts,
      url: `${opts.base.default}/${config.schedule.vouchers}`,
      method: "GET"
    });
...
const cancelVoucher = async (opts, params) => {
  /**
  * Validate opts
  */
  if (!validate.authenticated(opts)) {
  ...
  try {
    ...
    const response = await request({
      ...opts,
      url: `${opts.base.default}/${config.schedule.voucher}`,
      body: JSON.stringify(params),
      method: "DELETE"
    });
